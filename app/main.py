...
def move():
    ...
    for dirs in possibleDirs:
        if dirs == 'left':
            ...
            print "left;newPos;left"
            print newPos
            print board[newPos][ourCoords[1]]
            if newPos < 0 or board[newPos][ourCoords[1]] == 1:
               del dirs
        elif dirs == 'right':
            newPos = ourCoords[0] + 1
            if newPos >= data['width'] or board[newPos][ourCoords[1]] == 1:
               del dirs
        elif dirs == 'up':
            newPos = ourCoords[1] - 1
            if newPos < 0 or board[ourCoords[0]][newPos] == 1:
               del dirs
        elif dirs == 'down':
            newPos = ourCoords[1] + 1
            if newPos < 0 or board[ourCoords[0]][newPos] == 1:
